 ...
 * @author 51930
 */
public class Categoria_UI extends javax.swing.JInternalFrame {

    /**
     * Creates new form Categoria_UI
     */
    public Categoria_UI() {
        initComponents();
        reportar();
        ...
        try {
            ...
            if (txtNombre.getText().length() > 0) {
                ...
                if (txtDescripcion.getText().length() > 0) {
                    ...
                    objCategoria.setCaNombre(txtNombre.getText().toUpperCase());
                    objCategoria.setCaDescripcion(txtDescripcion.getText().toUpperCase());

                    CategoriaBD objeto_categoriaBD = new CategoriaBD();
                    objeto_categoriaBD.registrarCategoria(objCategoria);
            ...
            if (txtId.getText().length() > 0) {
                if (txtNombre.getText().length() > 0) {
                    if (txtDescripcion.getText().length() > 0) {
                        ...
                        ObjMarca.setIdCategoria(codigo);
                        ObjMarca.setCaNombre(txtNombre.getText().toUpperCase());
                        ObjMarca.setCaDescripcion(txtDescripcion.getText().toUpperCase());

                        CategoriaBD objeto_categoriaBD = new CategoriaBD();
                        objeto_categoriaBD.modificarCategoria(ObjMarca);
    ...
    private void eliminar() {
        try {
            if (txtId.getText().length() > 0) {
                ...
                if (aviso == 0) {
                    CategoriaBD objeto_marcaBD = new CategoriaBD();

                    int dni = Integer.parseInt(txtId.getText());
                    objeto_marcaBD.eliminarCategoria(dni);
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("MANTENIMIENTO CATEGORIAS"));
        ...
        tabla_reporte_categorias.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabla_reporte_categoriasMouseClicked(evt);
            }
    ...
    private void txtValorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtValorKeyPressed
        ...
        try {
            ...
            CategoriaBD objeto_categoriaBD = new CategoriaBD();
            tabla_temporal = objeto_categoriaBD.buscarCategoria(valor);
            tabla_reporte_categorias.setModel(tabla_temporal);
    ...
    private void tabla_reporte_categoriasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_reporte_categoriasMouseClicked

    }//GEN-LAST:event_tabla_reporte_categoriasMouseClicked
    ...
    private void tabla_reporte_categoriasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_reporte_categoriasMousePressed
        if (evt.getClickCount() == 2) {
            ...
            txtDescripcion.setText(tabla_reporte_categorias.getValueAt(fila_seleccionada, 2).toString());
